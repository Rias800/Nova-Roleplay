...
module.exports = {
    ...
    execute: async (interaction, client) => {
        ...
        const row = new ActionRowBuilder()
            .addComponents(
                new ButtonBuilder().setCustomId('claim').setLabel('Sahiplen').setEmoji({ name: "📩" }).setStyle(ButtonStyle.Secondary),
                new ButtonBuilder().setCustomId('close').setLabel('Kapat').setEmoji({ name: "🗑" }).setStyle(ButtonStyle.Danger),
                new ButtonBuilder().setCustomId('transcript').setLabel('Transkript').setEmoji({ name: "📁" }).setStyle(ButtonStyle.Primary)                
            )
